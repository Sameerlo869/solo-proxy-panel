...
# Remove any old HTML_TEMPLATE or dashboard definitions
...
if "if __name__ == '__main__':" in content:
    content = content.replace("if __name__ == '__main__':", elite_code + "\n\nif __name__ == '__main__':")
else:
    content += "\n" + elite_code
...
print("SUCCESS! Elite Glassmorphic UI applied cleanly without syntax errors.")
